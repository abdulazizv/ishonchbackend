...
export class CreateDiscountDto {
  ...
  @ApiProperty({
    example: '120000000',
    description: 'price of discount_product',
  })
  @IsNumber({}, { message: "product_price number bo'lishi kerak" })
  readonly product_price: number;
  @ApiProperty({
    example: '1',
    description: 'id of currency of discount_product',
  })
  ...
  @ApiProperty({
    example: '1',
    description: 'description_id of discount_product',
  })
  ...
  @ApiProperty({
    example: '1',
    description: 'appliances_characterics of discount_product',
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: '2',
    description: 'notebook_characterics of discount_product',
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: '1',
    description: 'phone_characterics id of discount_product',
  })
  @IsOptional()
  ...
  @IsBoolean({
    message: 'is_delivery faqat true yoki false qiymat qabul qiladi',
  })
  readonly is_delivery: boolean;
  @ApiProperty({
    example: 'false',
    description: 'discount_product is new or not ?',
  })
